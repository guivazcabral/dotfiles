...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter', 'neogit', 'nvim-lsp-installer', 'nvim-colorizer.lua', 'FixCursorHold.nvim', 'vim-abolish', 'vim-rails', 'neoscroll.nvim', 'markdown-preview.nvim', 'nvim-lspconfig', 'lspsaga.nvim', 'vim-test', 'nvim-cmp'}, { event = "BufRead *" }, _G.packer_plugins)]]
