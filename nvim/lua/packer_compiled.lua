...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'neoscroll.nvim', 'markdown-preview.nvim', 'lspsaga.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'neogit', 'nvim-lsp-installer', 'vim-test', 'FixCursorHold.nvim', 'vim-rails', 'nvim-colorizer.lua', 'nvim-lspconfig', 'vim-abolish', 'nvim-cmp'}, { event = "BufRead *" }, _G.packer_plugins)]]
