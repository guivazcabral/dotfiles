...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'neogit', 'nvim-treesitter', 'lspsaga.nvim', 'neoscroll.nvim', 'nvim-cmp', 'nvim-lsp-installer', 'vim-rails', 'nvim-lspconfig', 'markdown-preview.nvim', 'vim-abolish', 'nvim-colorizer.lua', 'gitsigns.nvim', 'vim-test'}, { event = "BufRead *" }, _G.packer_plugins)]]
