...
_G.packer_plugins = {
  ...
  ["dashboard-nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/guilherme/.local/share/nvim/site/pack/packer/opt/dashboard-nvim",
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag", "nvim-treesitter-context", "nvim-ts-rainbow" },
...
pcall(vim.api.nvim_create_user_command, 'ToggleTerm', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'nvim-toggleterm.lua'}, {}, _G.packer_plugins)
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'markdown-preview.nvim', 'neogit', 'lspsaga.nvim', 'FixCursorHold.nvim', 'gitsigns.nvim', 'nvim-lsp-installer', 'nvim-cmp', 'nvim-lspconfig', 'vim-test', 'nvim-colorizer.lua', 'vim-rails', 'nvim-treesitter', 'neoscroll.nvim', 'vim-abolish'}, { event = "BufRead *" }, _G.packer_plugins)]]
