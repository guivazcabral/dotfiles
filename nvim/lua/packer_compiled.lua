...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-rails', 'FixCursorHold.nvim', 'neoscroll.nvim', 'markdown-preview.nvim', 'lspsaga.nvim', 'gitsigns.nvim', 'nvim-lsp-installer', 'vim-abolish', 'nvim-treesitter', 'nvim-cmp', 'nvim-lspconfig', 'neogit', 'vim-test', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
