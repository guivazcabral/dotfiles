...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'markdown-preview.nvim', 'FixCursorHold.nvim', 'lspsaga.nvim', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-lspconfig', 'nvim-lsp-installer', 'nvim-cmp', 'vim-rails', 'nvim-colorizer.lua', 'neogit', 'vim-test', 'vim-abolish', 'neoscroll.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
