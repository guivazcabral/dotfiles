...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-ts-autotag", "nvim-treesitter-context" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-cmp', 'vim-test', 'lspsaga.nvim', 'markdown-preview.nvim', 'FixCursorHold.nvim', 'nvim-colorizer.lua', 'nvim-lspconfig', 'nvim-lsp-installer', 'neoscroll.nvim', 'vim-abolish', 'nvim-treesitter', 'neogit', 'gitsigns.nvim', 'vim-rails'}, { event = "BufRead *" }, _G.packer_plugins)]]
