...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-test', 'nvim-treesitter', 'nvim-lspconfig', 'nvim-lsp-installer', 'gitsigns.nvim', 'lspsaga.nvim', 'FixCursorHold.nvim', 'markdown-preview.nvim', 'neoscroll.nvim', 'nvim-cmp', 'vim-abolish', 'vim-rails', 'neogit'}, { event = "BufRead *" }, _G.packer_plugins)]]
