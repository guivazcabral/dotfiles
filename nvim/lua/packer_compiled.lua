...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'markdown-preview.nvim', 'lspsaga.nvim', 'gitsigns.nvim', 'nvim-cmp', 'vim-test', 'nvim-lspconfig', 'FixCursorHold.nvim', 'nvim-treesitter', 'nvim-lsp-installer', 'nvim-colorizer.lua', 'vim-rails', 'neogit', 'vim-abolish', 'neoscroll.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
