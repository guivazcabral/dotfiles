...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'markdown-preview.nvim', 'neoscroll.nvim', 'vim-rails', 'nvim-cmp', 'vim-test', 'nvim-colorizer.lua', 'nvim-treesitter', 'lspsaga.nvim', 'neogit', 'nvim-lspconfig', 'gitsigns.nvim', 'nvim-lsp-installer', 'vim-abolish'}, { event = "BufRead *" }, _G.packer_plugins)]]
