...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'gitsigns.nvim', 'vim-test', 'nvim-lspconfig', 'vim-rails', 'nvim-colorizer.lua', 'vim-abolish', 'nvim-cmp', 'FixCursorHold.nvim', 'neoscroll.nvim', 'nvim-lsp-installer', 'markdown-preview.nvim', 'lspsaga.nvim', 'neogit'}, { event = "BufRead *" }, _G.packer_plugins)]]
